...
*Submitted via the BTCOnline merchant report form*`;
  ...
  /* ── Comment/review endpoints removed ──
   * Comments and star ratings are now Nostr kind-1111 events published to the
   * canonical relay. See client/src/hooks/use-comments.ts for the client-side
   * relay query and publish logic. The old DB-backed REST endpoints have been
   * removed. Migration of historical data is task #102.
   */
