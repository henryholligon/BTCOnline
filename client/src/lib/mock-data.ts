...
export const MOCK_MERCHANTS: Merchant[] = [
  ...
  },
  {
    ...
    categories: ["VPN & Privacy", "Charity"],
    shippingCountries: ["Worldwide"],
  ...
  },
  {
    id: "50",
    name: "Start9 Labs",
    description: "Specialists in sovereign personal server hardware. High-end privacy-focused computing equipment.",
    logo: "/assets/start9-logo.png",
    categories: ["Electronics", "Hosting"],
    shippingCountries: ["Worldwide"],
    website: "https://start9.com",
  ...
  },
  {
    id: "51",
    name: "Samen Maier",
    description: "Artisan seed merchant providing high-quality vegetable and flower seeds. Supporting sustainable gardening and biodiversity.",
  ...
  },
  {
    ...
    description: "Premium kiln-dried firewood delivered throughout the UK. High-quality logs for stoves and open fires.",
    logo: "/assets/lincoln-logs-new.png",
    categories: ["Lifestyle"],
    shippingCountries: ["UK"],
