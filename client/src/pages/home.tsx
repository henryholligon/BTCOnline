  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans selection:bg-primary/20">
      ...
      <footer className="border-t border-border/40 py-8 bg-background mt-auto">
        <div className="container px-4 flex items-center justify-center gap-4 text-sm">
          <span className="font-display font-bold text-foreground">btconline</span>
          <a href="https://github.com/henryholligon/BTCOnline" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors text-muted-foreground" aria-label="GitHub repository">
