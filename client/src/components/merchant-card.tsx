        ...
        <div className="flex-1 min-w-0 space-y-1">
          <div className="flex items-center gap-2">
            ...
            {merchant.name === "Obscura VPN" && (
              <span className="shrink-0 text-[11px] font-black px-1.5 py-0.5 rounded-sm uppercase tracking-wide animate-fire" style={{ background: "radial-gradient(ellipse at 50% 100%, #fff7a1 0%, #ffdd57 10%, #ffb400 20%, #ff8c00 30%, #ff5e00 40%, #ff3d00 50%, #e63900 60%, #cc0000 70%, #990000 85%, #4d0000 100%)", backgroundSize: "200% 200%", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>🔥 HOT</span>
            )}
          </div>
