      ...
      <div className="flex items-center gap-4 p-3 md:p-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            {merchant.name === "SLNT" && (
              <span className="shrink-0 text-[10px] font-bold px-1.5 py-0.5 rounded-sm uppercase tracking-wide animate-rainbow" style={{ background: "linear-gradient(90deg, #b03030, #b06030, #30b040, #3070b0, #7030b0, #b03080, #b03030)", backgroundSize: "200% 100%", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>NEW</span>
            )}
          </div>
